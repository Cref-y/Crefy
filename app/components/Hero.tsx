    ...
    <div className="bg-background py-20 md:py-32 overflow-hidden relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            A modular identity and credentials infrastructure, moving toward an app-chain model to enable ZK-native
            verification, programmable attestations, and decentralized trust across ecosystems.
          </motion.p>
          <motion.div
          ...
          >
            ...
            <Button
              ...
              size="lg"
              className="w-full sm:w-auto"
              onClick={() => window.open("https://crefy-did.vercel.app/", "_blank")}
            >
              Explore Credentials
            </Button>
          </motion.div>
